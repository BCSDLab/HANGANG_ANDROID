...
const val LECTURE_BANKS_HIT = "$LECTURE_BANKS/hit/{id}"
const val LECTURE_BANKS_PURCHASE = "$LECTURE_BANKS/purchase/{id}"
const val LECTURE_BANKS_PURCHASE_CHECK = "$LECTURE_BANKS/purchase/check/{id}"
...
const val LECTURE_BANKS_COMMENT = "$LECTURE_BANKS/{id}/comment"
